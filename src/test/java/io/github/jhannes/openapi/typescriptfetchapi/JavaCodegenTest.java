...
public class JavaCodegenTest {
    ...
    void launchCodeGenerator() {
        ...
        final CodegenConfigurator configurator = new CodegenConfigurator()
                .setGeneratorName("java-annotationfree") // use this codegen library
                .setInputSpec("https://raw.githubusercontent.com/openapitools/openapi-generator/master/modules/openapi-generator/src/test/resources/2_0/petstore.yaml") // or from the server
                .setModelPackage("io.github.jhannes.openapi.demo.petstore.model")
                .setApiPackage("io.github.jhannes.openapi.demo.petstore.api")
                .setModelNameSuffix("Dto")
                .setOutputDir("target/out/java"); // output directory
    ...
    void shouldGenerateWithClassHierarchy() {
      final CodegenConfigurator configurator = new CodegenConfigurator()
              ...
              .setPackageName("io.github.jhannes.openapi.petstore")
              .setOutputDir("target/out/java"); // output directory
