...
import io.github.jhannes.openapi.infectionTracker.auth.Authentication;
import io.github.jhannes.openapi.infectionTracker.auth.HttpBasicAuth;
import io.github.jhannes.openapi.infectionTracker.auth.HttpBearerAuth;
import io.github.jhannes.openapi.infectionTracker.auth.ApiKeyAuth;
...
public class ApiClient {
  ...
  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    ...
    new ServerConfiguration(
      "https://infectiontracker.example.gov/api",
      "production",
      new HashMap<String, ServerVariable>()
    )
  ));
  ...
  public ApiClient() {
    ...
    setUserAgent("OpenAPI-Generator/1.0.0-draft/java");
